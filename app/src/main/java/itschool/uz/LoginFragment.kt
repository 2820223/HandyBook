...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.kirish).setOnClickListener {
            val email = view.findViewById<EditText>(R.id.email).text.toString()
            val password = view.findViewById<EditText>(R.id.parol).text.toString()
    ...
    private fun isValidCredentials(email: String, password: String): Boolean {
        val savedEmail = sharedPreferencesHelper.getUserEmail()
        val savedPassword = sharedPreferencesHelper.getUserPassword()
